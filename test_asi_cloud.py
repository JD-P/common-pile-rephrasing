...
async def send_rephrase_request(session, template_name, user_message):
    """Send a single rephrase request to the API"""
    print(API_KEY)
    headers = {
...
async def main():
    ...
    async with aiohttp.ClientSession() as session:
        ...
        for template in TEMPLATES:
            ...
            task = send_rephrase_request(session, template["name"], formatted_user_message)
            tasks.append(task)
